...
import OrganizationTabContainer from '../../containers/Tabs/Organization';
// Context
import { ToastProvider } from '../../context/toasts';
// Constants
import { ORGANIZATION_TAB, ACCOUNT_TAB, ADMIN_TAB, ENODE_TAB, PERMISSION_TAB } from '../../constants/tabs';
      ...
      <ToastProvider>
        ...
        <AdminDataProvider>
          <OrganizationDataProvider>
            <OrganizationTabContainer isOpen={tab === ORGANIZATION_TAB}/>
          </OrganizationDataProvider>
          <AccountDataProvider>
