...
export interface Organization extends BaseContract {
  ...
  addOrganization: TypedContractMethod<
    [cnpj: string, name: string, orgType: BigNumberish, canVote: boolean],
    [bigint],
    "nonpayable"
  >;
  ...
  filters: {
    "OrganizationAdded(uint256,string,string,uint8,bool)": TypedContractEvent<
      OrganizationAddedEvent.InputTuple,
      OrganizationAddedEvent.OutputTuple,
      OrganizationAddedEvent.OutputObject
    >;
    ...
    "OrganizationUpdated(uint256,string,string,uint8,bool)": TypedContractEvent<
      OrganizationUpdatedEvent.InputTuple,
      OrganizationUpdatedEvent.OutputTuple,
      OrganizationUpdatedEvent.OutputObject
    >;
